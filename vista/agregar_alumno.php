						...
						<div class="col-md-12">
							<div class="box box-danger">
								...
								<div class="box-body">
									...
									<td class="pad"><a class="btn btn-warning" href="editar_alumno.php?alumno=<?php echo $row['id_alumno']?>" role="button" style="border-radius: 0;" data-toggle="tooltip" data-placement="top" title="Editar Alumno"><span class="icon-wrench"></span></a></td>									<td class="pad"><a data-confirm-link="¿Imprimir Inscripción?" class="btn btn-success" href="../controlador/imprimir_inscripcion.php?alumno=<?php echo $row['id_alumno']?>" role="button" style="border-radius: 0;" data-toggle="tooltip" data-placement="top" title="Imprimir Inscripción"><span class="icon-printer"></span></a></td>
									</tr>
									<?php } ?>
									</tbody>
									</table>

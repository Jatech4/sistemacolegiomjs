...
$expresa=$_POST['expresa'];
$promovido=$_POST['promovido'];
$grado_superior=$_POST['grado_superior'];

$sql="UPDATE boletines SET id_representante='$id_representante',id_docente='$id_docente',ano_escolar=$ano_escolar,grado='$grado',seccion='$seccion',fecha_desde_momento1='$fecha_desde_momento1',fecha_hasta_momento1='$fecha_hasta_momento1',observaciones_gen_momento1='$observaciones_gen_momento1',recomendaciones_doc_momento1='$recomendaciones_doc_momento1',observaciones_alumno_momento1='$observaciones_alumno_momento1',observaciones_rep_momento1='$observaciones_rep_momento1',dias_hab_momento1='$dias_hab_momento1',asistencias_momento1='$asistencias_momento1',inasistencias_momento1='$inasistencias_momento1',fecha_momento1='$fecha_momento1',fecha_desde_momento2='$fecha_desde_momento2',fecha_hasta_momento2='$fecha_hasta_momento2',proyecto_momento2='$proyecto_momento2',informe_glob_momento2='$informe_glob_momento2',recomendaciones_doc_momento2='$recomendaciones_doc_momento2',observaciones_alumno_momento2='$observaciones_alumno_momento2',observaciones_rep_momento2='$observaciones_rep_momento2',dias_hab_momento2='$dias_hab_momento2',asistencias_momento2='$asistencias_momento2',inasistencias_momento2='$inasistencias_momento2',fecha_momento2='$fecha_momento2',fecha_desde_momento3='$fecha_desde_momento3',fecha_hasta_momento3='$fecha_hasta_momento3',proyecto_momento3='$proyecto_momento3',informe_glob_momento3='$informe_glob_momento3',recomendaciones_doc_momento3='$recomendaciones_doc_momento3',observaciones_alumno_momento3='$observaciones_alumno_momento3',observaciones_rep_momento3='$observaciones_rep_momento3',dias_hab_momento3='$dias_hab_momento3',asistencias_momento3='$asistencias_momento3',inasistencias_momento3='$inasistencias_momento3',fecha_momento3='$fecha_momento3',fecha_desde_momento4='$fecha_desde_momento4',fecha_hasta_momento4='$fecha_hasta_momento4',proyecto_momento4='$proyecto_momento4',informe_glob_momento4='$informe_glob_momento4',recomendaciones_doc_momento4='$recomendaciones_doc_momento4',observaciones_alumno_momento4='$observaciones_alumno_momento4',observaciones_rep_momento4='$observaciones_rep_momento4',dias_hab_momento4='$dias_hab_momento4',asistencias_momento4='$asistencias_momento4',inasistencias_momento4='$inasistencias_momento4',fecha_momento4='$fecha_momento4',literal='$literal',expresa='$expresa',promovido='$promovido',grado_superior='$grado_superior' WHERE id_boletin=$id";
$result = mysql_query($sql);
echo mysql_error();
mysql_close();
?>
 <script languaje="javascript">
  alert("\u00A1Boletin Modificado\u0021");

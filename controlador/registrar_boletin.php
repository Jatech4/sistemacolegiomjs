...
$nota_momento1=$_POST['nota_momento1'];
$nota_momento2=$_POST['nota_momento2'];
$nota_momento3=$_POST['nota_momento3'];
$nota_momento4=$_POST['nota_momento4'];

$sql="SELECT id_boletin FROM boletines WHERE id_alumno='$id_alumno' AND ano_escolar=$ano_escolar";
